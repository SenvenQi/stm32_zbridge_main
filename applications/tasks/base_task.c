...
//THREAD_WHILE_INIT_START(splash_screen,RT_NULL,1024,25,10)
THREAD_WHILE_INIT_START(lcd_point_shan,RT_NULL,1024,25,10)
THREAD_SEM_INIT_START(read_rfid_handle,rfid_sem,RT_NULL,1024,9,10)
