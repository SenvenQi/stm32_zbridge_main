 ...
 *********************/
#ifndef LCD_W
    #warning Please define or replace the macro LCD_W with the actual screen width, default value 320 is used for now.
    #define LCD_W    320
#endif

#ifndef LCD_H
    #warning Please define or replace the macro LCD_W with the actual screen height, default value 240 is used for now.
    #define LCD_H   172
#endif
